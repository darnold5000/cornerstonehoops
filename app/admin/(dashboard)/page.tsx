        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {cards.map((card) => {
            const className = cn(
              ...
              card.href &&
                "hover:border-[#0a0a0a]/40 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0a0a0a]",
            );
              ...
              <>
                ...
                <p
                  className={cn(
                    ...
                    card.href ? "text-[#0a0a0a]" : "text-muted-foreground",
                  )}
                >
                  {card.hint}
                  {card.href ? " →" : ""}
